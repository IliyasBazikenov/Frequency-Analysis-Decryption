...
namespace Frequency_Analysis_Decryption
{
    ...
    {
        private Dictionary<string, double> _charAndFreq;

        private Dictionary<string, double> СharAndFreq
        {
            get => new Dictionary<string, double>(_charAndFreq);
        }
        public FrequencyDictionary()
        {
            _charAndFreq = GetTheorFrequency();

        }

        public FrequencyDictionary(Dictionary<string, double> charAndFreq)
        {
            _charAndFreq = new Dictionary<string, double>(charAndFreq);

        }

        public static Dictionary<string, double> GetTheorFrequency()
        {
            var keyValues = new Dictionary<string, double>();
